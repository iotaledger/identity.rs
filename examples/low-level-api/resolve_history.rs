...
async fn main() -> Result<()> {
  ...
  let int_doc_1 = {
    ...
    let keys_1: KeyPair = KeyPair::new_ed25519().map_err(|_|Error::FailedKeyPairGeneration)?;
  ...
  let int_doc_2 = {
    ...
    let keys_2: KeyPair = KeyPair::new_ed25519().map_err(|_|Error::FailedKeyPairGeneration)?;
