...
async fn main() -> anyhow::Result<()> {
  ...
  let issuer = CoreDID::from_str(decoded_credential.credential.issuer.url().as_str()).unwrap();
  ...
  selective_disclosure_presentation.undisclose_subject("id").unwrap();
  ...
  // selective_disclosure_presentation.set_undisclosed("id").unwrap();
  // selective_disclosure_presentation.set_undisclosed("vc.credentialSubject.id").unwrap();
  // selective_disclosure_presentation.set_undisclosed("vc.credentialSubject.mainCourses[1]").unwrap();
  ...
  // ===========================================================================
  println!("Sending presentation (as JPT) to the verifier: {}", presentation_jpt.as_str());
