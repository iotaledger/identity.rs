...
| 9 | [merkle_key](./low-level-api/merkle_key.rs) | Adds a MerkleKeyCollection verification method to an Issuers DID Document and signs a Verifiable Credential one of its keys. Afterwards the key is deactivated, revoking the VC. |
