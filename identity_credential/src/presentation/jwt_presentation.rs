...
//
// impl<T> GetSignature for JwtPresentation<T> {
//   fn signature(&self) -> Option<&Proof> {
//     self.proof.as_ref()
//   }
// }
//
// impl<T> GetSignatureMut for JwtPresentation<T> {
//   fn signature_mut(&mut self) -> Option<&mut Proof> {
//     self.proof.as_mut()
//   }
// }
//
// impl<T> SetSignature for JwtPresentation<T> {
...
mod tests {
  ...
  // #[test]
  // fn test_from_json() {
  //   let presentation: JwtPresentation = JwtPresentation::from_json(JSON).unwrap();
