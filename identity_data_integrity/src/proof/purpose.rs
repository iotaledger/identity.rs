...
//TODO: Should we just use the MethodRelationship definition?
// That would simplify things, but the spec does technically allow for arbitrary string values.
...
impl ProofPurpose {
  ...
  /// Indicates that a proof is used for for key agreement protocols, such as Elliptic Curve Diffie Hellman key
  /// agreement used by popular encryption libraries.
  ///
  /// See the description in the [W3C DataIntegrityProof specification](https://w3c.github.io/vc-data-integrity/#proof-purposes).  
