...
impl KeyCollection {
  ...
  /// error is returned. This upper limit may be increased in the future. If this function fails to create a
  /// [`KeyCollection`] with a matching private key for every public key then
