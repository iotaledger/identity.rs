...
async function resolveHistory(clientConfig) {
    ...
    intDoc1.signSelf(key, intDoc1.authentication().id.toString());
    ...
    const diff1 = intDoc1.diff(diffDoc1, intReceipt1.messageId, key, intDoc1.authentication().id.toString());
    ...
    const diff2 = diffDoc1.diff(diffDoc2, diffReceipt1.messageId, key, diffDoc1.authentication().id.toString());
    ...
    intDoc2.signSelf(key, intDoc2.authentication().id.toString());
