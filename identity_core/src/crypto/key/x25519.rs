...
mod tests {
  ...
  fn test_x25519_test_vector() {
    ...
    let alice_secret_key: Vec<u8> = BaseEncoding::decode(
      "77076d0a7318a57d3c16c17251b26645df4c2f87ebc0992ab177fba51db92c2a",
      Base::Base16Lower,
    )
    .unwrap();
    let alice_public_key: Vec<u8> = BaseEncoding::decode(
      "8520f0098930a754748b7ddcb43ef75a0dbf3a0d26381af4eba4a98eaa9b4e6a",
      Base::Base16Lower,
    )
    .unwrap();
    let bob_secret_key: Vec<u8> = BaseEncoding::decode(
      "5dab087e624a8a4b79e17f8b83800ee66f3bb1292618b6fd1c2f8b27ff88e0eb",
      Base::Base16Lower,
    )
    .unwrap();
    let bob_public_key: Vec<u8> = BaseEncoding::decode(
    ...
    assert_eq!(
      BaseEncoding::encode(&alice_secret, Base::Base16Lower),
      expected_secret_hex
    );
    assert_eq!(
      BaseEncoding::encode(&bob_secret, Base::Base16Lower),
      expected_secret_hex
    );
  }
