...
#[derive(Debug, PartialEq, Clone, Diff, Deserialize, Serialize)]
...
#[derive(Debug, PartialEq, Clone, Deserialize, Serialize, Diff)]
pub enum KeyData {
...
#[derive(Debug, Clone, Default, PartialEq, Diff, Deserialize, Serialize)]
