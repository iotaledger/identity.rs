# Description 
This PR simplifies the library by removing the Document trait as well as all generics on `CoreDocument`, `Service`,`VerificationMethod` and `DomainLinkageService`. 
...
- Potentially/Quite possibly leads to more runtime checks in some places.   
