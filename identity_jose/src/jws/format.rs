...
pub enum JwsFormat {
  ...
  Compact,
  /// General JWS JSON Serialization (<https://www.rfc-editor.org/rfc/rfc7515#section-3.2>).
  General,
  /// Flattened JWS JSON Serialization (<https://www.rfc-editor.org/rfc/rfc7515#section-3.2>).
  ///
