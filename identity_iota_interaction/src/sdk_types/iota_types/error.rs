...
use super::{
    ...
    digests::{ObjectDigest, TransactionDigest, WrappedDigest},
...
pub enum UserInputError {
    ...
    CheckpointContentsNotFound(WrappedDigest),
...
pub enum IotaError {
    ...
    QuorumFailedToGetEffectsQuorumWhenProcessingTransaction {
        effects_map: BTreeMap<WrappedDigest, (Vec<AuthorityName>, StakeUnit)>,
    },
    #[error(
    ...
    TransactionEventsNotFound { digest: WrappedDigest },
    #[error(
