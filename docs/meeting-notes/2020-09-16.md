...
- identity have to allow that people can use their own cryto algorithms.



### Account Module

Uses the accound module stronghold or does it also include logic nand act as a higher level library?  
