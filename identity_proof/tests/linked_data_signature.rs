...
fn test_parse_lds_bbsblssignature2020() {
    test_parse_lds!("BbsBlsSignature2020", "fixtures/signature/bbsblssignature2020.json");
}
...
fn test_parse_lds_ecdsasecp256k1signature2019() {
    test_parse_lds!(
        ...
        "fixtures/signature/ecdsasecp256k1signature2019.json"
    );
}

#[test]
fn test_parse_lds_ed25519signature2018() {
    test_parse_lds!("Ed25519Signature2018", "fixtures/signature/ed25519signature2018.json");
}
...
fn test_parse_lds_jcsed25519signature2020() {
    test_parse_lds!(
        ...
        "fixtures/signature/jcsed25519signature2020.json"
    );
}

#[test]
fn test_parse_lds_jsonwebsignature2020() {
    test_parse_lds!("JsonWebSignature2020", "fixtures/signature/jsonwebsignature2020.json");
}

#[test]
fn test_parse_lds_rsasignature2018() {
    test_parse_lds!("RsaSignature2018", "fixtures/signature/rsasignature2018.json");
}
