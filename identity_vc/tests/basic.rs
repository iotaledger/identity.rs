...
fn test_credential_builder() {
  let credential: Credential = CredentialBuilder::new("did:example:i55u3r")
...
fn test_validate_credential_subject() {
  CredentialBuilder::new("did:issuer").build().unwrap();
}

#[test]
#[should_panic = "Invalid credential subject (empty)"]
fn test_validate_credential_subject_empty() {
  CredentialBuilder::new("did:issuer").subject(object!()).build().unwrap();
}

#[test]
#[should_panic = "Invalid URI `foo`"]
fn test_validate_issuer_bad_uri_1() {
  CredentialBuilder::new("foo")
...
fn test_validate_issuance_date_1() {
  CredentialBuilder::new("did:issuer")
    .subject(object!(id: "did:sub"))
    .build()
    .unwrap();
}
...
fn test_validate_issuance_date_2() {
  CredentialBuilder::new("did:issuer")
    .subject(object!(id: "did:sub"))
    .issuance_date("woo")
    .build()
