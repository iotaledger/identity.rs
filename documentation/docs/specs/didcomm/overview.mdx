...
| [Revocation Options](./protocols/revocation-options.mdx) | 0.1 | Allows discovery of available [`RevocationInfo`](./protocols/revocation.md#RevocationInfo) types for use with the [revocation](./protocols/revocation.mdx) protocol. |
