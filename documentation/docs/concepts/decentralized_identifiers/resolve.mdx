...
- Resolve
---
import resolve_did_custom_rs from '!!raw-loader!../../../../examples/1_advanced/5_custom_resolution.rs';
import resolve_did_custom_js from '!!raw-loader!../../../../bindings/wasm/examples/src/1_advanced/4_custom_resolution.ts';
...
<CodeSnippet
    ...
    nodeGithubLink="https://github.com/iotaledger/identity.rs/blob/main/bindings/wasm/examples/src/1_advanced/4_custom_resolution.ts"
    rustGithubLink="https://github.com/iotaledger/identity.rs/blob/main/examples/1_advanced/5_custom_resolution.rs"
/>
