...
import resolve_did_js from '!!raw-loader!../../../../bindings/wasm/examples/src/0_basic/2_resolve_did.ts';
...
<CodeSnippet
    ...
    nodeGithubLink="https://github.com/iotaledger/identity.rs/blob/main/bindings/wasm/examples/src/0_basic/2_resolve_did.ts"
    rustGithubLink="https://github.com/iotaledger/identity.rs/blob/main/examples/0_basic/2_resolve_did.rs"
/>
