...
<CodeSnippet
    ...
    nodeGithubLink = "https://github.com/iotaledger/identity.rs/blob/support/v0.6/bindings/wasm/examples-account/src/create_vp.ts"
    rustGithubLink = "https://github.com/iotaledger/identity.rs/blob/support/v0.6/examples/account/create_vp.rs"
/>
