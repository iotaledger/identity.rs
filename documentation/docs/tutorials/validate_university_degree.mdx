...
|Term   | Definition    |
|:---   |:---           |
| [Decentralized Identifier (DID)](https://www.w3.org/TR/did-core/#dfn-decentralized-identifiers) |A globally unique persistent identifier that does not require a centralized registration authority and is often generated or registered cryptographically.|
...
The IOTA Foundation verifies Alice and the University's signatures again by checking the verifiable presentation and discovers that the University revoked its signature.
