...
You should note that the newly added verification method is of the *type* `MerkleKeyCollection`.
...
You should note that the newly added verification method is of the *type* "Ed25519VerificationKey".
